...
class newspro_posts_news_1_widget extends WP_Widget {
    function __construct() {
        $widget_ops = array('classname' => 'pop_news_block_1', 'description' => __('Posts News block 1', 'newspro'));
   ...
   <a href="' .esc_url(get_permalink()). '">
          <div class="pop_post_news pop_large_news" style="background-image: url('.$img_src.')">
				<div class="overlay">
				<div class="pop_post_data ">
								<span class="p_title">'.$post_title.'</span>								
								<div class="row pop_post_block_meta">
